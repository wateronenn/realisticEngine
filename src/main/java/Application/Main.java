...
public class Main extends Application {
    ...
    public static void showMenu(Stage stage) {
        ...
        VBox root = new VBox();
        Image bg = new Image(Main.class.getResource("/temp_background.png").toExternalForm());
        ...
        ImageView img1 = new ImageView(new Image(Main.class.getResource("/test_char.png").toExternalForm()));
        ...
        startBtn.setOnAction(e -> {
            CharacterSelectionScene.show(stage);
        });
